...
\newcommand{\coloredsection}[1]{%
  \colorbox{\sectioncolor!60}{\parbox{\dimexpr\textwidth-2\fboxsep}{\thesection\ #1}}}

\newcommand{\coloredsubsection}[1]{%
  \colorbox{\subsectioncolor!40}{\parbox{\dimexpr\textwidth-2\fboxsep}{\thesubsection\ #1}}}

\newcommand{\coloredsubsubsection}[1]{%
  \colorbox{\subsubsectioncolor!20}{\parbox{\dimexpr\textwidth-2\fboxsep}{\thesubsubsection\ #1}}}
